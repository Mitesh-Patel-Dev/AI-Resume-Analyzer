...
const ProgressBar = ({ value, max, color }) => {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <span className="text-sm font-semibold text-dark-300 w-16 text-right">
        {value}/{max}
      </span>
    </div>
  );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-dark-400">Analyzing your resume...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="glass-card p-10 text-center max-w-md">
          ...
          <Link
            to="/dashboard"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary-600 hover:bg-primary-500 text-white rounded-xl transition-colors"
          >
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-primary-600/10 rounded-full blur-[140px]" />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8 animate-fade-in">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-primary-600 to-accent-600 hover:from-primary-500 hover:to-accent-500 text-white font-semibold rounded-xl transition-all shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40 text-sm"
          >
        ...
        <div className="glass-card p-8 mb-6 animate-fade-in">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex items-center gap-2 justify-center lg:justify-start text-dark-400 mb-4">
                <FiFileText />
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-3 mt-4">
                <div>
                  <p className="text-xs text-dark-500 mb-1">Content</p>
                  <ProgressBar
                ...
                <div>
                  <p className="text-xs text-dark-500 mb-1">Skills</p>
                  <ProgressBar
                ...
                <div>
                  <p className="text-xs text-dark-500 mb-1">Formatting</p>
                  <ProgressBar
                ...
                <div>
                  <p className="text-xs text-dark-500 mb-1">Impact</p>
                  <ProgressBar
        ...
        {/* ═══ Tab Navigation ═══ */}
        <div className="flex gap-1 mb-6 overflow-x-auto p-1 bg-dark-800/50 rounded-xl animate-slide-up">
          {tabs.map((tab) => (
            <button
              key={tab.key}
            ...
            <div className="glass-card p-6">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-dark-500">{resume.detectedSkills?.length || 0} skills found</p>
                </div>
              </div>
              <div className="flex flex-wrap gap-2">
                ...
                {(resume.detectedSkills?.length || 0) > 15 && (
                  ...
                  >
                    +{resume.detectedSkills.length - 15} more →
                  </button>
                )}
              </div>
            </div>
            ...
            <div className="glass-card p-6">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-dark-500">In-demand skills to add</p>
                </div>
              </div>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="glass-card p-6">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-primary-500/20 rounded-xl flex items-center justify-center">
                  <FiBriefcase className="text-primary-400 text-lg" />
                </div>
                <div>
                  <h2 className="text-lg font-bold text-white">Best Job Matches</h2>
                  <p className="text-xs text-dark-500">Top role fits</p>
                </div>
              </div>
              <div className="space-y-3">
                {(resume.jobRoleMatches || []).slice(0, 3).map((jm, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <span className="text-sm text-dark-300 flex-1 truncate">{jm.role}</span>
            ...
            {(resume.skillCategories || []).length > 0 && (
              <div className="glass-card p-6">
                <h2 className="text-lg font-bold text-white mb-5 flex items-center gap-2">
                  <FiLayers className="text-primary-400" /> Skills by Category
                </h2>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {resume.skillCategories.map((cat, i) => (
                    <div key={i} className="p-4 bg-dark-800/40 rounded-xl border border-dark-700/30">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="glass-card p-6">
                <h2 className="text-lg font-bold text-white mb-4">
                  ✅ All Detected Skills ({resume.detectedSkills?.length || 0})
                </h2>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="glass-card p-6">
                <h2 className="text-lg font-bold text-white mb-4">
                  ⚠️ Missing In-Demand Skills ({resume.missingSkills?.length || 0})
                </h2>
                <div className="flex flex-wrap gap-2">
                  {(resume.missingSkills || []).map((skill, i) => (
        ...
        {activeTab === "roles" && (
          <div className="space-y-6 animate-fade-in">
            <div className="glass-card p-6">
              <h2 className="text-lg font-bold text-white mb-5 flex items-center gap-2">
                <FiBriefcase className="text-primary-400" /> Job Role Matching
              </h2>
                ...
                {(resume.jobRoleMatches || []).map((jm, i) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        {i === 0 && (
                          <span className="px-2 py-0.5 text-xs font-bold bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-md">
                            BEST FIT
                          </span>
                        )}
                    ...
                    <div className="w-full h-2.5 bg-dark-800 rounded-full overflow-hidden mb-4">
                      <div
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                      <div>
                        <p className="text-xs text-dark-500 mb-2">Matched Skills</p>
                        <div className="flex flex-wrap gap-1.5">
                      ...
                      <div>
                        <p className="text-xs text-dark-500 mb-2">Skills to Add</p>
                        <div className="flex flex-wrap gap-1.5">
          ...
          <div className="space-y-4 animate-fade-in">
            {(resume.sectionFeedback || []).map((sf, i) => (
              <div key={i} className="glass-card p-6">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-dark-500">Score: {sf.score}/100</p>
                    </div>
                  </div>
                  <StatusBadge status={sf.status} />
                </div>
                ...
                <p className="text-dark-300 text-sm mb-3">{sf.feedback}</p>

                {sf.tips?.length > 0 && (
                  <div className="space-y-2">
                    <p className="text-xs font-semibold text-dark-500 uppercase tracking-wider">Tips to improve:</p>
                    {sf.tips.map((tip, j) => (
                      <div key={j} className="flex items-start gap-2 p-3 bg-dark-800/50 rounded-lg border border-dark-700/30">
                        <HiOutlineLightBulb className="text-accent-400 flex-shrink-0 mt-0.5" />
                        <p className="text-sm text-dark-400">{tip}</p>
                      </div>
                    ))}
                  </div>
                )}
          ...
          <div className="glass-card p-6 animate-fade-in">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-dark-500">AI-powered tips to boost your resume</p>
              </div>
            </div>
            <div className="space-y-3">
              {(resume.suggestions || []).map((suggestion, i) => (
                <div
                  key={i}
                  className="flex items-start gap-3 p-4 bg-dark-800/50 rounded-xl border border-dark-700/50"
                >
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up">
          <Link
            to="/upload"
            className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-primary-600 to-accent-600 hover:from-primary-500 hover:to-accent-500 text-white font-semibold rounded-xl transition-all shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40"
          >
